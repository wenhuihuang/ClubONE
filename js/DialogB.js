(function ($) {
        ...
        readerDom : function () {
            ...
            if($('.dialog-con').length < 1  ){
                var html = '<div class="dialog-con">'+
                    ...
                    '<iframe  frameborder="0" scrolling=no class="iframe" src="'+self.settings.url+'" frameborder="0" style="width:100%;height:100%;"></iframe>'+
                    '</div>';
            ...
            $('.close-btn').css({
                ...
                top:"20px",
                cursor: "pointer",
                background:"url(img/close_icon.gif) no-repeat center center"
            })
        },
        show:function () {
    ...
    window.DialogB=window['DialogB']=DialogB;
})(jQuery)
